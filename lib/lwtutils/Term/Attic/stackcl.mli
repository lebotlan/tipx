...
val def: string -> (('a -> 'b -> 'c, 'd) acu -> 'e) -> 'e
  
val (!>): 'a -> ('b -> 'c stack -> 'c stack * ('d -> 'b), 'c -> 'd result) acu ->
  (('b -> 'c stack -> 'c stack * 'b, 'a) acu -> 'e) -> 'e
  
type ('b, 'c) def

val (+==): ((('a -> 'b stack -> 'c stack * 'd, ('d, 'c) ret_value) acu ->
             ('b, 'c) def) -> 'e) -> 'a -> string -> 'e
